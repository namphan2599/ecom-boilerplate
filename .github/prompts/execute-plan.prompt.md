...
2. **Use Memory for Context** — Search for prior implementation notes/patterns before starting: `ai-devkit memory search --query "<feature implementation plan>"`.
...
6. **Store Reusable Knowledge** — Save reusable implementation guidance/decisions with `ai-devkit memory store ...`.
