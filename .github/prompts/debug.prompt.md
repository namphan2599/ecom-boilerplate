...
2. **Use Memory for Context** — Search memory for similar incidents/fixes before deep investigation: `ai-devkit memory search --query "<issue symptoms or error>"`.
...
7. **Store Reusable Knowledge** — Save root-cause and fix patterns via `ai-devkit memory store ...`.
