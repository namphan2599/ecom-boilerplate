...
2. **Use Memory for Context** — Search memory for prior knowledge about this module/domain: `ai-devkit memory search --query "<entry point or subsystem>"`.
...
7. **Store Reusable Knowledge** — If insights should persist across sessions, store them using `ai-devkit memory store ...`.
