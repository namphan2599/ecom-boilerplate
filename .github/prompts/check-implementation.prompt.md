...
2. **Use Memory for Context** — Search memory for known constraints and prior decisions before assessing mismatches: `ai-devkit memory search --query "<feature implementation alignment>"`.
...
5. **Store Reusable Knowledge** — Save recurring alignment lessons/patterns with `ai-devkit memory store ...`.
