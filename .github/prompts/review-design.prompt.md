...
1. **Use Memory for Context** — Search memory for prior architecture constraints/patterns: `ai-devkit memory search --query "<feature design architecture>"`.
2. Summarize:
...
4. **Store Reusable Knowledge** — Persist approved design patterns/constraints with `ai-devkit memory store ...` when they will help future work.
