...
# Disable multiprocessing by patching
import concurrent.futures
_original_executor = concurrent.futures.ProcessPoolExecutor
class SingleThreadedExecutor(concurrent.futures.ProcessPoolExecutor):
    def __init__(self, *args, **kwargs):
        kwargs['max_workers'] = 1
        super().__init__(*args, **kwargs)
concurrent.futures.ProcessPoolExecutor = SingleThreadedExecutor
